...
`news-scrap-codex`의 기사 수집은 `검색 회수율 확보 -> 원문 검증 -> freeze 고정`의 3단 구조로 고정한다. 목표는 단순히 많이 모으는 것이 아니라, 의료 AI·응급의료 AI·응급실 AI·중환자실 AI 관련 국내 기사 누락을 줄이면서도 매주 비슷한 품질과 구조의 기사 묶음을 만드는 것이다.
