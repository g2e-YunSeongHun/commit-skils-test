#!/usr/bin/env python3
"""Remove generated files from a news-scrap-codex-v2 run directory."""
...
GENERATED_FILES = {
    ...
    "pencil_slide_spec.json",
    "pencil_slide_artifact.json",
    "pencil_failure.json",
}
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Delete generated news-scrap-codex-v2 outputs from one run directory."
    )
